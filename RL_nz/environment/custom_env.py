...
class CustomEnv:
    def __init__(self, config):
        ...
        self.solar_intensity_cache = solar_intensity()*20
    ...
    def encode_state(self):
        ...
        return self._encode_state(self.get_power(), self._time, self._message_queue_length)
    ...
    def transition(self, action):
        ...
        self._device.take_action(action)
